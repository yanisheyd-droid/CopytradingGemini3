...
private _isRunning: boolean = false; // Renommé pour éviter le conflit TS2300
...
if (!this._isRunning) return; // CORRECTION: isRunning -> _isRunning
...
isRunning(): boolean {
return this._isRunning; // CORRECTION: isRunning -> _isRunning
}
